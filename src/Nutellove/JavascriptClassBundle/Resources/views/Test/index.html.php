...
<script src="<?php echo $pathToWeb ?>bundles/javascriptclass/jsclass/mootools/entity/BaseEntityAbstract.class.js" type="text/javascript"></script>
<script src="<?php echo $pathToWeb ?>bundles/javascriptclass/jsclass/mootools/entity/javascriptclassbundle/base/BaseAnt.class.js" type="text/javascript"></script>
<script src="<?php echo $pathToWeb ?>bundles/javascriptclass/jsclass/mootools/entity/javascriptclassbundle/Ant.class.js" type="text/javascript"></script>
